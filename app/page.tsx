    ...
    return (
        <div className="flex flex-col mt-8">
             <div className="flex flex-wrap justify-center text-center">
              ...
              <div className="justify-center md:scale-95 md:flex">{row0.map((row,i) => <div key={i}><ImageBox src={row.src} width={row.width} height={row.height}></ImageBox></div>)}

                    </div></div>
                    <div className="flex flex-wrap w-full">
                        <div className="justify-center md:scale-95 md:flex">{row1.map((row, i) => <div key={i}><ImageBox src={row.src} width={row.width} height={row.height}></ImageBox></div>)}
                    </div></div>
                </div>
